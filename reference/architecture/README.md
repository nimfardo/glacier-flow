...
2. Write it up as `reference/architecture/[pattern-name].md` — layers/folders, import rules, where domain vocabulary specific to the pattern lives (e.g. Layer/Slice/Segment for FSD, Atom/Molecule/Organism for Atomic Design).
